!(function (t, e) {
  ...
  let o = !1;
  function s() {
    return "CL v26.002 (internal id 2dcfe7d4 @ 2023-09-18T14:22:15.636Z)";
  }
  const r = class {
    constructor(t) {
      var i, s;
      ...
      "dark" === (null !== (s = this._options.theme) && void 0 !== s ? s : "light").toLowerCase() &&
        ...
        this._options.debug &&
          (o || ((o = !0), console.log("Using CL v26.002 (internal id 2dcfe7d4 @ 2023-09-18T14:22:15.636Z)"))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _render(t) {
      ...
      const n = (function (t, e) {
        ...
        const o = new URL(`${t || ""}`, location.href).href,
          s = JSON.parse(
            '["bundles/runtime.73eaf5da31fa198fb54c.js","bundles/__LANG__.5008.e5d7d914577969582fa4.js","bundles/3515.2f722d33cebe31a154b1.css","bundles/1564.5d23a32481002f127c65.js","bundles/library.5bb35e99444d9b20e189.js"]',
          ),
